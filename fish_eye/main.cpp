...
int main()
{
    ...
    for (int i=1; i<=52; i++) {
        ...
        str << "/home/einstein/桌面/vision4/vision4/carmera_blue"  << i << ".jpg";
    ...
    //cv::Size newSize(static_cast<int>(image.cols*2.5), static_cast<int>(image.rows*2.5));
    ...
    cv::FileStorage fs("/home/einstein/桌面/camera.xml", cv::FileStorage::WRITE);
